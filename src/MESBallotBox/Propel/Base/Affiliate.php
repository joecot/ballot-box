...
abstract class Affiliate implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MESBallotBox\\Propel\\Map\\AffiliateTableMap';
    ...
    /**
     * Initializes internal state of MESBallotBox\Propel\Base\Affiliate object.
     */
    ...
    /**
     * Compares this with another <code>Affiliate</code> instance.  If
     * <code>obj</code> is an instance of <code>Affiliate</code>, delegates to
     * <code>equals(Affiliate)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Affiliate The current object, for fluid interface
     */
     ...
     * @return $this|\MESBallotBox\Propel\Affiliate The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AffiliateTableMap::COL_ID] = true;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AffiliateTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AffiliateTableMap::translateFieldName('id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AffiliateTableMap::translateFieldName('name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = AffiliateTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MESBallotBox\\Propel\\Affiliate'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAffiliateQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Affiliate::setDeleted()
     * @see Affiliate::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAffiliateQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AffiliateTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AffiliateTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AffiliateTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AffiliateTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AffiliateTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO Affiliate (%s) VALUES (%s)',
    ...
    {
        $pos = AffiliateTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Affiliate'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Affiliate'][$this->hashCode()] = true;
        $keys = AffiliateTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MESBallotBox\Propel\Affiliate
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MESBallotBox\Propel\Affiliate The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AffiliateTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AffiliateTableMap::COL_ID)) {
            $criteria->add(AffiliateTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AffiliateTableMap::COL_NAME)) {
            $criteria->add(AffiliateTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildAffiliateQuery::create();
        $criteria->add(AffiliateTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MESBallotBox\Propel\Affiliate (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MESBallotBox\Propel\Affiliate Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAffiliate is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAffiliate The current object (for fluent API support)
     */
    public function setVoters(Collection $voters, ConnectionInterface $con = null)
    {
        ...
        foreach ($votersToDelete as $voterRemoved) {
            $voterRemoved->setAffiliate(null);
        }
    ...
    {
        return (string) $this->exportTo(AffiliateTableMap::DEFAULT_STRING_FORMAT);
    }
