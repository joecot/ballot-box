 ...
 *
 * @method     \MESBallotBox\Propel\QuestionQuery|\MESBallotBox\Propel\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CandidateQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, question_id, user_id, application FROM Candidate WHERE id = :p0';
        try {
