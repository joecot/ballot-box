...
/**
 * Base class that represents a row from the 'Vote_version' table.
 *
 *
 *
...
abstract class VoteVersion implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MESBallotBox\\Propel\\Map\\VoteVersionTableMap';
    ...
    /**
     * Initializes internal state of MESBallotBox\Propel\Base\VoteVersion object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>VoteVersion</code> instance.  If
     * <code>obj</code> is an instance of <code>VoteVersion</code>, delegates to
     * <code>equals(VoteVersion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|VoteVersion The current object, for fluid interface
     */
     ...
     * @return $this|\MESBallotBox\Propel\VoteVersion The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VoteVersionTableMap::COL_ID] = true;
        }
    ...
    public function setballotId($v)
    {
        ...
        if ($this->ballot_id !== $v) {
            $this->ballot_id = $v;
            $this->modifiedColumns[VoteVersionTableMap::COL_BALLOT_ID] = true;
        }
    ...
    public function setuserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[VoteVersionTableMap::COL_USER_ID] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[VoteVersionTableMap::COL_VERSION] = true;
        }
    ...
    public function setVersionCreatedBy($v)
    {
        ...
        if ($this->version_created_by !== $v) {
            ...
            $this->modifiedColumns[VoteVersionTableMap::COL_VERSION_CREATED_BY] = true;
        }
    ...
    public function setBallotIdVersion($v)
    {
        ...
        if ($this->ballot_id_version !== $v) {
            ...
            $this->modifiedColumns[VoteVersionTableMap::COL_BALLOT_ID_VERSION] = true;
        }
    ...
    public function setVoteItemIds($v)
    {
        if ($this->vote_item_ids_unserialized !== $v) {
            ...
            $this->modifiedColumns[VoteVersionTableMap::COL_VOTE_ITEM_IDS] = true;
        }
    ...
    public function setVoteItemVersions($v)
    {
        if ($this->vote_item_versions_unserialized !== $v) {
            ...
            $this->modifiedColumns[VoteVersionTableMap::COL_VOTE_ITEM_VERSIONS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VoteVersionTableMap::translateFieldName('id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VoteVersionTableMap::translateFieldName('ballotId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ballot_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VoteVersionTableMap::translateFieldName('userId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VoteVersionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VoteVersionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VoteVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : VoteVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : VoteVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : VoteVersionTableMap::translateFieldName('BallotIdVersion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ballot_id_version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : VoteVersionTableMap::translateFieldName('VoteItemIds', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vote_item_ids = $col;
            $this->vote_item_ids_unserialized = null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : VoteVersionTableMap::translateFieldName('VoteItemVersions', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = VoteVersionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MESBallotBox\\Propel\\VoteVersion'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildVoteVersionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see VoteVersion::setDeleted()
     * @see VoteVersion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVoteVersionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VoteVersionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VoteVersionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_BALLOT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ballot_id';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'version';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VERSION_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_at';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VERSION_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'version_created_by';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_BALLOT_ID_VERSION)) {
            $modifiedColumns[':p' . $index++]  = 'ballot_id_version';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VOTE_ITEM_IDS)) {
            $modifiedColumns[':p' . $index++]  = 'Vote_item_ids';
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VOTE_ITEM_VERSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'Vote_item_versions';
        }

        $sql = sprintf(
            'INSERT INTO Vote_version (%s) VALUES (%s)',
    ...
    {
        $pos = VoteVersionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['VoteVersion'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VoteVersion'][$this->hashCode()] = true;
        $keys = VoteVersionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            ...
            $keys[8] => $this->getBallotIdVersion(),
            $keys[9] => $this->getVoteItemIds(),
            $keys[10] => $this->getVoteItemVersions(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MESBallotBox\Propel\VoteVersion
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) {
            $this->setBallotIdVersion($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setVoteItemIds($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setVoteItemVersions($arr[$keys[10]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MESBallotBox\Propel\VoteVersion The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VoteVersionTableMap::COL_ID)) {
            $criteria->add(VoteVersionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_BALLOT_ID)) {
            $criteria->add(VoteVersionTableMap::COL_BALLOT_ID, $this->ballot_id);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_USER_ID)) {
            $criteria->add(VoteVersionTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_CREATED_AT)) {
            $criteria->add(VoteVersionTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_UPDATED_AT)) {
            $criteria->add(VoteVersionTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VERSION)) {
            $criteria->add(VoteVersionTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VERSION_CREATED_AT)) {
            $criteria->add(VoteVersionTableMap::COL_VERSION_CREATED_AT, $this->version_created_at);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VERSION_CREATED_BY)) {
            $criteria->add(VoteVersionTableMap::COL_VERSION_CREATED_BY, $this->version_created_by);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_BALLOT_ID_VERSION)) {
            $criteria->add(VoteVersionTableMap::COL_BALLOT_ID_VERSION, $this->ballot_id_version);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VOTE_ITEM_IDS)) {
            $criteria->add(VoteVersionTableMap::COL_VOTE_ITEM_IDS, $this->vote_item_ids);
        }
        if ($this->isColumnModified(VoteVersionTableMap::COL_VOTE_ITEM_VERSIONS)) {
            $criteria->add(VoteVersionTableMap::COL_VOTE_ITEM_VERSIONS, $this->vote_item_versions);
        }
    ...
    {
        $criteria = ChildVoteVersionQuery::create();
        $criteria->add(VoteVersionTableMap::COL_ID, $this->id);
        $criteria->add(VoteVersionTableMap::COL_VERSION, $this->version);
    ...
    public function hashCode()
    {
        ...
        //relation Vote_version_fk_3ff174 to table Vote
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MESBallotBox\Propel\VoteVersion (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MESBallotBox\Propel\VoteVersion Clone of current object.
     * @throws PropelException
     */
    ...
    public function getVote(ConnectionInterface $con = null)
    {
        if ($this->aVote === null && ($this->id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aVote->addVoteVersions($this);
             */
        }
    ...
    {
        if (null !== $this->aVote) {
            $this->aVote->removeVoteVersion($this);
        }
        $this->id = null;
        $this->ballot_id = null;
        $this->user_id = null;
    ...
    {
        return (string) $this->exportTo(VoteVersionTableMap::DEFAULT_STRING_FORMAT);
    }
